...
public class EDADialog extends JDialog implements DocumentListener {
    ...
    public EDADialog() {
        super(null, "EDA Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    EDADialog(ProjectOrganization organization) {
        super(null, "EDA Visualization Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
